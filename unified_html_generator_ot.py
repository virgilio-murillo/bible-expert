...
def generate_unified_html(book: str, chapter: int, chapter_data: dict, output_dir: Path) -> Path:
    ...
    from study_html_generator_ot import _s3_cache_get, _s3_cache_put
...
def _load_tc_analyses(book, chapter, apparatus, verses, morphology, manuscripts):
    ...
    from study_html_generator_ot import _s3_cache_get, _s3_cache_put, _strip_md
...
def _load_exeg_themes(book, chapter):
    ...
    from study_html_generator_ot import _s3_cache_get
...
def _regenerate_patr_themes(book, chapter, patristic):
    ...
    from study_html_generator_ot import _s3_cache_put, _strip_md
    import boto3
